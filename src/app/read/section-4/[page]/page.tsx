...
export default function Section4Page() {
    ...
    useEffect(() => {
        ...
        // Save progress (Intro: 2 + S1: 11 + S2: 6 + S3: 9 = 28 pages total before Section 4)
        if (authed) {
    ...
    const handleNext = async () => {
        ...
        if (!isLastPage) {
            ...
            // Mark Section 4 as completed (Index 4)
            if (isAuthed) {
                await authSystem.completeChapter(4)
            }
            router.push('/read/section-5/1') // Go to next chapter
        }
    }
    ...
    const handlePrev = () => {
        if (!isFirstPage) {
            ...
            // Navigate back to last page of Section 3 (9 pages)
            router.push('/read/section-3/9')
        }
    }
    ...
    return (
        <>
            ...
            <LockedOverlay
                ...
                nextPath={`/read/section-4/${pageNum}`}
            ...
            <main style={{ minHeight: '100vh', position: 'relative', overflow: 'hidden', paddingTop: '0' }}>
                ...
                <div className="container" style={{ paddingBottom: '40px', maxWidth: '1400px' }}>
                    ...
                    <div className="reading-actions-bar">
                        <BookmarkButton 
                            pageId={`section-4-${pageNum}`} 
                            pageTitle={`الفصل 04: ${currentPage.title}`} 
                        />
                    </div>
